      ...
      <section className="flex flex-col md:flex-row items-center mb-12 bg-offwhite py-20 px-20 gap-8">
        ...
        <div className="md:w-1/2">
          ...
          <p className="text-gray-600 mb-6">
            It is a long established fact that a reader will be distracted by the <br /> readable content of a page when looking at its layout. The point of <br /> using Lorem Ipsum is that it has a more-or-less normal distribution <br /> of letters,
            as opposed, of a page when looking at its layout. The <br /> point of using Lorem Ipsum is that of a page when looking at its <br /> layout. The point of using Lorem Ipsum is thatLorem Ipsum is that it <br /> has a more-or-less
          ...
          <div className="flex gap-6">
            ...
            <div className="p-4 bg-[#FFFFFF] rounded-lg shadow-md flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-600">It is a long esta<br />-blished fact that</p>
              </div>
            </div>
            {/* Goal Box */}
            <div className="p-4 bg-[#FFFFFF] rounded-lg shadow-md flex items-center">
