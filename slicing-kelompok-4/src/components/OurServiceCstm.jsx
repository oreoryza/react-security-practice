    ...
    <section className="flex flex-col md:flex-row items-center mb-12 bg-offwhite py-20 md:px-24 px-10 gap-8">
      ...
      <div className="md:w-1/2">
        ...
        <p className="text-gray-600 mb-6">
          ...
          more-or-less normal distribution <br /> of letters, as opposed, of
          a page when looking at its layout. The <br /> point of using Lorem
          Ipsum is that of a page when looking at its <br /> layout. The
          point of using Lorem Ipsum is thatLorem Ipsum is that it <br />{" "}
...
export default OurServicesCstm;
