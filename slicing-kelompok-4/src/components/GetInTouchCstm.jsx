...
const GetInTouchCstm = () => {
  return (
    <div className="px-32 py-24 bg-darkblue">
      <div className="flex flex-col justify-center items-center">
        <h2 className="font-bold text-2xl text-peachred">\ Get In Touch \</h2>
        <h1 className="font-bold text-4xl text-whitecstm">Hey! Let's Talk</h1>
      </div>
